...
export default function ImageTextConverterPage() {
  ...
  const handleProcess = async () => {
    ...
    try {
      const data = await imageToolsApi.imageTextConverter(file);
      setResult(data);
    } catch (err: any) {
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="text-center mb-8">
          ...
          <h1 className="text-4xl font-bold text-gray-900 mb-2">Image Text Converter</h1>
          <p className="text-gray-600 text-lg">Extract text from images using OCR</p>
        </div>
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 mb-8">
          <div className="flex items-center justify-between mb-6">
            ...
            <div className="flex items-center gap-4">
              ...
              <span className="text-gray-600">Extract Text</span>
            </div>
          </div>
        ...
        {result && (
          <div className="bg-green-50 border border-green-200 rounded-lg p-6 mb-8">
            <div className="flex items-center justify-between mb-4">
              <h3 className="font-semibold text-green-900">Extracted Text:</h3>
              <button
                onClick={handleCopy}
            ...
            <div className="bg-white rounded-lg p-4 max-h-96 overflow-y-auto">
              <p className="text-gray-700 whitespace-pre-wrap">{result.text || 'No text found in image'}</p>
            </div>
          </div>
        )}
